...
<h2>Record List</h2>
	...
	<table width="800px">
		<tr><th>Format</th><th>Label Name</th><th>Record Title</th><th></th></tr>
		<?php
		//Print the contents
		$i=1;
		...
		?>
			...
			<td width="150px" ><a href="insert.php?id=<?php echo $record_id;?>">edit</a> <a href="#" onclick="deleteRecord('<?php echo $record_id."', '".$record_title;?>');">delete</a> <a href="#" onclick="dupRecord('<?php echo $record_id;?>');">duplicate</a></td>
		</tr>
		<?php
			$i=$i+1;
		} //while
