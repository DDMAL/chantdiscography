...
<div id="results">
	...
	$sql = "select DISTINCT title_of_chant from chant ORDER BY title_of_chant ";
	
	$result = mysql_query($sql) or die("Opps some thing went wrong");
	echo "<h3>Chants:</h3>";
	while($row = mysql_fetch_array($result)){
		echo "<span id='title'><a href='index.php?type=chant&searchtxt=".$row['title_of_chant']."'>".$row['title_of_chant']."</a></span><br>";
	}
